...
{
	//Debug::Print(FString::Printf(TEXT("SpawnProjectile at Location: %s"), *ProjectileTargetLocation.ToString()));
	...
	if (CombatInterface)
	{
		...
		//Debug::Print(FString::Printf(TEXT("FireBolt Damage: %f"), ScaleDamage));
